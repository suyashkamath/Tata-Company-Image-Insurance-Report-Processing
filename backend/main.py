...
#     {"LOB": "PVT CAR", "SEGMENT": "PVT CAR TP",  "PO": "90% of Payin", "REMARKS": "Payin Below 20%"},
#       {"LOB": "PVT CAR", "SEGMENT": "PVT CAR TP",  "PO": "90% of Payin", "REMARKS": "Payin Above 20%"},
#         {"LOB": "PVT CAR", "SEGMENT": "PVT CAR TP",  "PO": "90% of Payin", "REMARKS": "Payin Above 30%"},
#           {"LOB": "PVT CAR", "SEGMENT": "PVT CAR TP",  "PO": "90% of Payin", "REMARKS": "Payin Above 40%"},
#             {"LOB": "PVT CAR", "SEGMENT": "PVT CAR TP",  "PO": "90% of Payin", "REMARKS": "Payin Above 50%"},
...
# app.add_middleware(
#     CORSMiddleware,
#     allow_origins=["https://tata-image-report.vercel.app"],  # Your frontend
#     allow_credentials=True,
#     allow_methods=["*"],
#     allow_headers=["*"],
# )
...
Example 2 : 
There is one more example of how the data is given , so sometimes only PO and segment are given 
For example : Dear Sir, we are reviewing our school bus PO effective 10th Jan 2024.
Your final revised PO is 72% .
Pls note and communicate to all you concern stake holder .
From Tata
where the location and rest information are not given , so please keep that in mind 

Example 3: 

Sometimes in the data two tables are given with this column , 
Segment
PP/SATP
AGE
KOLKATA
...
where PP/SATP contains the policy type and KOLKATA, ROWB1,ROWB2 are the locations 

and also another table is given 
seperated by the location text

here are the columns
CV            |          | Package  | SATP
Business Type | Segment  | HP       | HP

so in CV rows , sometimes the age is mentioned
in segment , the segment and in package,satp : the values mentioned

Example 4: Sometimes column names are given in this way 
Segment  AP TS
AP TS are the state names and under it values are there

in segment column , sometimes segment are given and along it with policy type are given only for some instances
